...
func runUpdate(_ *cobra.Command, _ []string) error {
	...
	if cli.IsBrewInstall() {
		...
		if err != nil {
			...
			return fmt.Errorf("brew upgrade failed: %w\nYou can try manually: brew upgrade jahirsaiyed/tap/multica", err)
		}
	...
	if latest == nil {
		return fmt.Errorf("could not determine latest version; check https://github.com/jahirsaiyed/Multica/releases/latest")
	}
